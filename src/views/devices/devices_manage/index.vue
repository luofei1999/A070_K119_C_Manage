        ...
        <pane size="100">
          <el-col>
            <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
              ...
              <el-form-item label="流量卡号" prop="simCardNumber">
                <el-input v-model="queryParams.simCardNumber" placeholder="请输入流量卡号" clearable
                  @keyup.enter.native="handleQuery" />
              </el-form-item>
            ...
            <el-table v-loading="loading" :data="devices_manageList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="通信时间" align="center" prop="communicationTime" width="180">
                <template slot-scope="scope">
                  <span>{{ parseTime(scope.row.communicationTime, '{y}-{m}-{d} {h}:{m}') }}</span>
                </template>
              </el-table-column>
              <el-table-column label="流量卡号" align="center" prop="simCardNumber" />
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="状态" prop="status">
          <el-radio-group v-model="form.status">
            <el-radio v-for="dict in dict.type.device_status" :key="dict.value"
        ...
        <el-form-item label="通信时间" prop="communicationTime">
          <el-date-picker clearable v-model="form.communicationTime" type="date" value-format="yyyy-MM-dd"
            placeholder="请选择通信时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="流量卡号" prop="simCardNumber">
          <el-input v-model="form.simCardNumber" placeholder="请输入流量卡号" />
        </el-form-item>
